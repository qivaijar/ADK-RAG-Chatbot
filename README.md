...
For the evaluation, I used the RAGAS framework to assess the quality of the answers generated by my RAG agent, with an LLM serving as the evaluator (“judge”).

The evaluation can be triggered by running the evaluation.py script.
